package com.heyzqt.wechatmoments.bean;
...
public class MomentBean {
	...
	public static class CommentsBean {
		/**
		 * content : Good.
		 * sender : {"username":"outman","nick":"Super hero",
		 * "avatar":"https://encrypted-tbn3.gstatic
		 * .com/images?q=tbn:ANd9GcRJm8UXZ0mYtjv1a48RKkFkdyd4kOWLJB0o_l7GuTS8-q8VF64w"}
		 */

		private String content;
		private SenderOfComBean sender;
		...
		public SenderOfComBean getSender() {
			return sender;
		}

		public void setSender(SenderOfComBean sender) {
			this.sender = sender;
		}

		public static class SenderOfComBean {
			/**
			 * username : outman
			 * nick : Super hero
			 * avatar : https://encrypted-tbn3.gstatic
